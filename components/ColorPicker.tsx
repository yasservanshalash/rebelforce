...
export default function ColorPickerSection() {
  ...
  return (
    <View style={styles.container}>
        <View style={{padding: 3, borderRadius: 8, width: "85%",margin: "0 auto", flexDirection: "row", backgroundColor: "#EEE5D7", alignSelf: "center", justifyContent: "space-between"}}>
        ...
        <ColorPicker style={{ width: '95%', margin: "0 auto", alignSelf: "center" }} value='#BE38F3' onComplete={onSelectColor} onChange={onSelectColor}>
          <View style={{margin: 20}}>
          <Panel5 />
        </View>
        <Text>Opacity</Text>
        <View style={{flexDirection: "row", gap:20, width: "100%", margin: "0 auto", justifyContent: "space-between", alignContent:"space-between", paddingVertical: 20}}>
